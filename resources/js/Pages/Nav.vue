        ...
        <div class="container mx-auto" v-click-away="closeBread">
            <div class="mx-2 flex justify-between items-center gap-2">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button @click="toggleBread" type="button"
            ...
            <div v-show="breadIsOpen" x-transition style="display: none" class="" id="mobile-menu">
                <div
                    ...
                    <a href="https://github.com/jhonoryza"
                        class="block px-3 py-2 text-sm font-medium hover:text-rose-500" target="_blank">
                        My Github
                    </a>
                    <a href="https://rb.gy/uy8nj0" class="block px-3 py-2 text-sm font-medium hover:text-rose-500"
                        target="_blank">
                        My Portofolio
                    </a>
                    ...
                    <a :href="route('wire.home')" class="block px-3 py-2 text-sm font-medium hover:text-rose-500"
                        target="_blank">
                        Home using livewire
                    </a>
