      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="flex flex-col space-y-1 mx-4 text-primary dark:text-slate-300"${_scopeId}><h1 class="font-bold text-xl"${_scopeId}>PHP Packages</h1><div class="flex flex-col space-y-2"${_scopeId}><!--[-->`);
            ...
            return [
              ...
              createVNode("div", { class: "flex flex-col space-y-1 mx-4 text-primary dark:text-slate-300" }, [
                createVNode("h1", { class: "font-bold text-xl" }, "PHP Packages"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Package/PHP/Index.vue");
