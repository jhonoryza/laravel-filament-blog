<a href="{{ route('posts.show', $getRecord()->slug) }}" class="flex hover:bg-teal-100">
    ...
    <div class="flex flex-col justify-between px-2 w-full">
        ...
        <div class="flex flex-row mb-2 justify-between">
            ...
            <p class="text-xs font-bold  text-gray-500 dark:text-gray-400">{{ $getRecord()->created_at->format('F j, Y') }}</p>
        </div>
    </div>
</a>
