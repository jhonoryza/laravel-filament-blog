...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.vue`,
      /* @__PURE__ */ Object.assign({ "./Pages/Base.vue": () => import("./assets/Base-ByNzQINa.js"), "./Pages/Component/Index.vue": () => import("./assets/Index-Cd1gN9DB.js"), "./Pages/Footer.vue": () => import("./assets/Footer-B-2zln9Z.js"), "./Pages/Nav.vue": () => import("./assets/Nav-C-Br6y1g.js"), "./Pages/Package/DevTools/Index.vue": () => import("./assets/Index-BjwdGhTB.js"), "./Pages/Package/Go/Index.vue": () => import("./assets/Index-BakDdnPJ.js"), "./Pages/Package/PHP/Index.vue": () => import("./assets/Index-Ce-0RcBd.js"), "./Pages/Post/Index.vue": () => import("./assets/Index-GRXApm0j.js"), "./Pages/Post/Show.vue": () => import("./assets/Show-B7teRbDv.js"), "./Pages/ToggleDarkMode.vue": () => import("./assets/ToggleDarkMode-JFaivfUX.js") })
    ),
