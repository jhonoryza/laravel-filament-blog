...
>
    <x-tables.container>
            ...
            @if ((($records instanceof \Illuminate\Contracts\Pagination\Paginator) || ($records instanceof \Illuminate\Contracts\Pagination\CursorPaginator)) &&
             ((! ($records instanceof \Illuminate\Contracts\Pagination\LengthAwarePaginator)) || $records->total()))
                <x-tables.pagination
                    ...
                    :paginator="$records"
                    class="fi-ta-pagination px-3 py-3 sm:px-6 sm:hidden"
                />
            @endif
        ...
        <div
            ...
            @endif
            @class([
                'fi-ta-content overflow-x-auto dark:divide-white/10 dark:border-t-white/10',
                    ...
                    >
                        ...
                        @foreach ($records as $record)
                            ...
                            <div
                                ...
                                @endif
                                @class([
                                    'fi-ta-record relative h-full bg-white transition duration-75 dark:bg-gray-900 overflow-hidden',
